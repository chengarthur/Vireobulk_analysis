...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  7 14:39:45 2022
...
import numpy as np
import vireoSNP
from vireoSNP.utils.vcf_utils import read_sparse_GeneINFO
import pandas as pd
...
def merged_VCF_to_sdf(bulk_data_merge):
    ...
    testdf=pd.DataFrame(np.array(bulk_data_merge['FixedINFO']["INFO"]))
